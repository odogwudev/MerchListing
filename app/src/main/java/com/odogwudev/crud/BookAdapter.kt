...
import com.odogwudev.crud.R
import com.odogwudev.crud.BookClass
import com.odogwudev.crud.db.DataManager
import kotlinx.android.synthetic.main.edit_dialog.view.*
import kotlinx.android.synthetic.main.book_cardview.view.page

class BookAdapter(val list: ArrayList<BookClass>, val context: Context) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun bindViews(book: BookClass) {
            ...
            if (book.read == true) {
                itemView.findViewById<CardView>(R.id.card_view_book)
                    .setCardBackgroundColor(Color.parseColor("#F08080"))
            } else {
                itemView.findViewById<CardView>(R.id.card_view_book)
                    .setCardBackgroundColor(Color.parseColor("#8F9B356D"))
            }
